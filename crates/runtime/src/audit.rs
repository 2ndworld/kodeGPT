...
pub enum AuditAction {
    ...
    WorkspaceUntrust,
    WorkspaceCheckpointUpsert,
    WorkspaceCheckpointClear,
    WorkspaceRegister,
...
impl AuditAction {
    fn as_str(self) -> &'static str {
        match self {
            ...
            Self::WorkspaceCheckpointUpsert => "workspace_checkpoint_upsert",
            Self::WorkspaceCheckpointClear => "workspace_checkpoint_clear",
            ...
            Self::GitRepositoryIdentity => "git_repository_identity",
            ...
            Self::CiCancel => "ci_cancel",
            Self::CiDispatch => "ci_dispatch",
